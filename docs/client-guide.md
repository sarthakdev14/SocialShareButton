...
analytics tool you already use (Google Analytics, Mixpanel, Plausible, or your own).
...
- **Blogs & editorial sites** — boost organic reach on every article
- **E-commerce product pages** — shareable links that drive referral traffic
- **SaaS dashboards** — let users share reports or invite teammates
- **Portfolio & landing pages** — make every page shareworthy
